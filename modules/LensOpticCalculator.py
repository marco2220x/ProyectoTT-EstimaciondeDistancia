...
def SafetyLevel(distance): # Esta función debemos descartarla
    if distance > 3000: 
...
# En lugar de realizar calculos con la formula de lentes, podría usarse la matriz intrinseca con los valores de la calibración de la cámara?