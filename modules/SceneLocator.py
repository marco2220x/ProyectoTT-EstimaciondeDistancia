...
# En teoría la función FindObjects se ejecuta solo si se detecto el objeto target.
# Asi mismo se repite la detección de objetos como en la función FindTargetObject, quizá se puede optimizar o reducir la redundancia?
